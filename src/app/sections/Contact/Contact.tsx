...
export default function Contact() {
  return (
    <section id="contact" className="flex lg:min-h-[calc(100vh-4rem-9rem)] pt-16 pb-32 pt-32 md:pb-64 lg:py-0 items-center justify-center scroll-mt-16 bg-gray-950 text-white px-6">
